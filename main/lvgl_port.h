...
#define LVGL_PORT_TASK_MAX_DELAY_MS                                                                \
    (CONFIG_EXAMPLE_LVGL_PORT_TASK_MAX_DELAY_MS) // The maximum delay of the LVGL timer task, in
                                                 // milliseconds
#define LVGL_PORT_TASK_MIN_DELAY_MS                                                                \
    (CONFIG_EXAMPLE_LVGL_PORT_TASK_MIN_DELAY_MS) // The minimum delay of the LVGL timer task, in
                                                 // milliseconds
...
#define LVGL_PORT_TASK_PRIORITY                                                                    \
    (CONFIG_EXAMPLE_LVGL_PORT_TASK_PRIORITY) // The priority of the LVGL timer task
...
/**
 * Below configurations are automatically set according to the above configurations, users do not
 * need to modify them.
 *
 */
